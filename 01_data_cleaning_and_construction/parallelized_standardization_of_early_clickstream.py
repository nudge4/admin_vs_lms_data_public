...
The purpose of this script is to use parallel processing to speed up the process of standardizing the LMS measures within each term x college x course x section cell.
"""
...
class Standardizer(object):
    ...
    def do(self):
        ...
        # for var in ['on_time_assign_share_qtr1', 'assign_sub_cnt_am_qtr1', 'assign_sub_cnt_pm_qtr1', 'assign_sub_cnt_day_qtr1']:
        for var in ['on_time_assign_share_qtr1', 'assign_sub_cnt_qtr1']:
        ...
        df_sub.to_csv(fpath + "/standardized_early/{}.csv".format(self.indx), index=False)
...
if __name__ == '__main__':
    ...
    std_list = ['tot_click_cnt_qrt1',
                'tot_time_qrt1', 'avg_session_len_qrt1',
                'irreg_session_len_qrt1',
                'disc_post_cnt_qtr1', 'disc_reply_cnt_qtr1',
                'avg_word_tot_qtr1', 'avg_depth_post_qtr1']
    df = pd.read_stata(fpath + "/LMS_data_not_standardized.dta")
    ...
    pool = multiprocessing.Pool(18) # Use parallel processing to speed up this script
