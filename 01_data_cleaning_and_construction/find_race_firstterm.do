*Name: find_race_firstterm.do
*Author: Yifeng Song
*Purpose: Merge the VCCS Student files, extract demographic information of each student in the first-term observations, 
...
global sample_vccsid_list "~\Box Sync\Clickstream\data\first\all_vccsid.dta"
...
save "~\Box Sync\Clickstream\data\first\race.dta", replace
