/* This script creates the indicators for online and in-person courses in the study sample for first-term observations. */
...
save "~\\Box Sync\\Clickstream\\data\\first\\updated_online_ind.dta", replace
