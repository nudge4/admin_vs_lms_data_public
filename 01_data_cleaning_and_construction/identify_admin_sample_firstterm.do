...
student x term observations to be included in the study sample for first-term observations */
...
preserve
	...
	drop first_strm
	save "~\\Box Sync\\Clickstream\\data\\first\\all_vccsid_strm_temp.dta", replace
	drop strm
	duplicates drop
	sort vccsid
	tempfile vccsid_new
...
preserve
	use "~\\Box Sync\\Clickstream\\data\\first\\all_vccsid_strm_temp.dta", clear
	merge 1:1 vccsid strm using "~\\Box Sync\\Clickstream\\data\\full\\dual.dta", keep(1 3) nogen
	drop if dual_ind == 1
	drop dual_ind
	sort vccsid strm
	save "~\\Box Sync\\Clickstream\\data\\first\\all_vccsid_strm.dta", replace
	drop strm
	duplicates drop
	sort vccsid
	tempfile vccsid_new
...
save "~\Box Sync\Clickstream\data\first\temp_0.dta", replace


use "~\Box Sync\Clickstream\data\first\all_vccsid_strm.dta", replace
drop strm
duplicates drop
sort vccsid
save "~\Box Sync\Clickstream\data\first\all_vccsid.dta", replace


use "~\Box Sync\Clickstream\data\first\all_vccsid_strm.dta", clear
...
save "~\Box Sync\Clickstream\data\first\LMS_data_new.dta", replace
...
preserve
	zipuse "C:\Users\ys8mz\Downloads\Student_2021_3_spe.dta.zip", clear
	keep vccsid strm age gender new_race
	merge m:1 vccsid using "~\Box Sync\Clickstream\data\first\all_vccsid.dta", keep(3) nogen
	gen source = `i'
	tempfile stu_temp_`i'
...
merge 1:m vccsid using "~\Box Sync\Clickstream\data\first\temp_0.dta", keep(2 3) nogen
...
sort vccsid strm
isid vccsid strm
merge 1:1 vccsid strm using "~\\Box Sync\\Clickstream\\data\\first\\all_vccsid_strm.dta", keep(3) nogen
sort vccsid strm
save "~\\Box Sync\\Clickstream\\data\\first\\age_gpa_earn.dta", replace
