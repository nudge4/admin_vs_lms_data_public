/* This script generates the 2-digit CIP and degree level of each student x term, for all non-first-term observations.*/
...
order vccsid strm
drop cip_counts
save "~\\Box Sync\\Clickstream\\data\\full\\cip_degree.dta", replace
