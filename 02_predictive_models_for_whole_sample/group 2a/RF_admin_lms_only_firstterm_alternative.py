# This script fits the admin_only and lms_only RF model on all first-term observations without imputation of missing values -- just naturally treat missing values as one separate category.
...
df = pd.read_stata("LMS_data_final.dta")
